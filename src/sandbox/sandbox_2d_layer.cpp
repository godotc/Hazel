...
void Sandbox2D::OnAttach()
{
    ...
    m_ActiveScene->GetRegistry().emplace<hazel::TransformComponent>(entity);
    m_ActiveScene->GetRegistry().emplace<hazel::SpriteRendererComponent>(entity, glm::vec4{1, 0, 0, 0});
